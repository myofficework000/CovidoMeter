package co.abhishek.coronavirustracking.ui.feature.preferencescreen
...
import co.abhishek.coronavirustracking.utils.NotifyWorker
import co.abhishek.coronavirustracking.utils.Utils
import co.kyald.coronavirustracking.ui.feature.mainscreen.ProfileActivity
            ...
            if (preference is ListPreference) {
                ...
                if (preference.key == Constants.PREF_THEME) {
                    onPreferenceChange(
                        ...
                        PreferenceManager
                            .getDefaultSharedPreferences(preference.context)
                            .getString(preference.key, Constants.THEME.LIGHT.value)
                    )
                }
            }
