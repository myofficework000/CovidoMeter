package co.abhishek.coronavirustracking.ui.feature.mainscreen
...
import co.abhishek.coronavirustracking.data.database.model.CoronaEntity
import co.abhishek.coronavirustracking.ui.feature.mainscreen.bottomsheet.CoronaRecyclerViewAdapter
import co.abhishek.coronavirustracking.ui.feature.preferencescreen.PreferenceActivity
import co.abhishek.coronavirustracking.utils.Constants
import co.abhishek.coronavirustracking.utils.Utils
import co.abhishek.coronavirustracking.utils.extensions.gone
import co.abhishek.coronavirustracking.utils.extensions.setSafeOnClickListener
import co.abhishek.coronavirustracking.utils.extensions.toSimpleString
import co.abhishek.coronavirustracking.utils.extensions.visible
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initMap(savedInstanceState: Bundle?) {
        ...
        mapView.getMapAsync { map ->
            this.mapboxMap = map
            map.setStyle(
                when (preferences.getString(Constants.PREF_THEME, "1")?.toInt()!!) {
