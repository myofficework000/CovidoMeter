package co.abhishek.coronavirustracking.data.network.category

import co.abhishek.coronavirustracking.data.database.model.arcgis.S3CoronaEntityResponse
import co.abhishek.coronavirustracking.data.database.model.arcgis.S3CoronaEntityResponseCases
